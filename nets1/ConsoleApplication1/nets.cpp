...
int main() {
    ...
    const char* reqPath = "C:\\Users\\пк\\OneDrive\\Документы\\KubSU\\comp nets\\Infile.txt";
    const char* ansPath = "C:\\Users\\пк\\OneDrive\\Документы\\KubSU\\comp nets\\Outfile.txt";
    ...
    while (true) {
        ...
        if (current_size > last_size) {
            ...
            cout << "Received request - Name: " << B.name << ", Date of Birth: "
                << B.day << "-" << B.month << "-" << B.year << ", Calculated age: "
                << age.years << " years, " << age.months << " months, " << age.days << " days." << endl;
